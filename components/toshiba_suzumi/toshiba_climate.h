...
static const uint8_t SPECIAL_TEMP_OFFSET = 14;
static const uint8_t SPECIAL_MODE_EIGHT_DEG_MIN_TEMP = 3;
static const uint8_t SPECIAL_MODE_EIGHT_DEG_MAX_TEMP = 18;
